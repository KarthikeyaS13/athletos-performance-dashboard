  ...
  for (let i = 29; i >= 0; i--) {
    ...
    if (sport !== "Rest") {
      ...
      workouts.push({
        ...
        rpe: Math.min(10, rpe),
        loadScore: calculateTrainingLoad(
          sport,
          distance,
          durationStr,
          Math.min(10, rpe),
  ...
  const races = [
    {
      ...
      date: format(subDays(today, -42), "yyyy-MM-dd"),
      distance: 21.1,
      type: "Running",
      targetTime: "01:45:00",
    },
    {
      ...
      date: format(subDays(today, -112), "yyyy-MM-dd"),
      distance: 42.2,
      type: "Running",
      targetTime: "03:45:00",
    },
  ...
  const prs = {
    Running: {
      "5K": {
        ...
        previousValue: "00:23:15",
      },
      "10K": {
        value: "00:48:10",
        date: format(subDays(today, 60), "yyyy-MM-dd"),
        previousValue: "00:50:00",
      },
      "Half Marathon": {
        value: "01:50:00",
